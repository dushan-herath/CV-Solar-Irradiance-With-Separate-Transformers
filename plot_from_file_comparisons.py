...
def plot_predictions_vs_time_separate(models_data, target_names,
    ...
    colors = {
        "Actual": "black",
        "Full Model": "tab:blue",
        "Only Time Series Encoder": "tab:green",
        "Only Image Encoder": "tab:red",
    }
...
# ----------------------------------------------------
# Main script — loads 3 models, creates all plots
# ----------------------------------------------------
def main():
    model_files = {
        "Full Model": "forecast_results_cropped.npz",
        "Only Time Series Encoder": "forecast_results_cropped_without_image_series_encoder.npz",
        "Only Image Encoder": "forecast_results_cropped_without_time_series_encoder.npz",
    }
    ...
    target_names = models_data["Full Model"]["target_names"]
